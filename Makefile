...
deploy:
	@forge script script/deploy/DeployMerkleAirdrop.s.sol:DeployMerkleAirdrop $(NETWORK_ARGS)
...
claim:;
	@forge script script/interactions/ClaimInteraction.s.sol:ClaimInteraction --sender ${DEFAULT_ANVIL_ADDRESS_2} --rpc-url http://localhost:8545 --private-key $(DEFAULT_ANVIL_KEY_2) --broadcast
...
# masalaToken: contract MasalaToken 0x5FbDB2315678afecb367f032d93F642f64180aa3
# merkleAirdrop: contract MerkleAirdrop 0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512
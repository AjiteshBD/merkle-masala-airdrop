...
ROOT="0x7cdb6c21ef22a6cb5726d348e677f3e10032127425d425c5028965a30a71556e"
PROOF_1="0x72995a443d90c829031cb42be582996fb8747dc02130f358dba0ad65c8db5119"
PROOF_2="0xe5ebd1e1b5a5478a944ecab36a9a954ac3b6b8216875f6524caa7a1d87096576"


# Compile and deploy MasalaToken contract
echo "Creating zkSync local node..."
npx zksync-cli dev start
echo "Deploying token contract..."
TOKEN_ADDRESS=$(forge create src/MasalaToken.sol:MasalaToken --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync | awk '/Deployed to:/ {print $3}' )
